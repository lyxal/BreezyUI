...
root.geometry("800x600") #Set the size of the window
    ...
    for i in range(len(dragged_widgets)):
        ...
        print("object{0} = tkinter.{1}(root, {2})".format(i, widget.widget_type, to_export))

        print("object{0}.place(x={1},y={2})".format(i, widget.widget.winfo_x(), widget.widget.winfo_y()))

        if widget.widget_type == "Entry":
            if widget.widget.get():
                print("object{0}.insert(0, {1})".format(i, widget.widget.get()))
