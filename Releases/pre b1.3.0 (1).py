...
def save_bUI_file():
    ...
    for widget in dragged_widgets:
        widget_config = {"id" : widget.name, "x" : widget.widget.winfo_x(), "y" : widget.widget.winfo_y(), "attributes" : bUI.changed_dict(widget.attributes, bUI.get_attributes(widget.widget))}
